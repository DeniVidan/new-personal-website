...
const Footer = () => {
  ...
  return (
    <footer ref={footerRef} className="bg-[#E1E1E1] text-white pt-10 pb-6 w-full">
      <div className="container mx-auto md:px-8 lg:px-16">
        ...
        <div className="flex justify-between items-center mb-8 pl-8">
          ...
          <button 
            onClick={scrollToTop}
            className="px-8 py-3 md:px-12 md:py-4 md:text-xl rounded-full bg-transparent border border-red-500 text-red-500 hover:opacity-90 transition-opacity focus:outline-none"
          >
            BACK TO TOP
          </button>
        </div>
          ...
          <div className="relative w-full md:w-1/2 mb-16 md:mb-0 order-1 md:order-2">
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <button
                ...
                className="px-8 py-3 rounded-full bg-gradient-to-r from-red-500 to-orange-500 hover:opacity-90 transition-opacity focus:outline-none text-white font-bold"
              >
                Let's Work Together
              </button>
            </div>
